...
Q_CONSTINIT static const qt_meta_stringdata_CLASSMenuScreenENDCLASS_t qt_meta_stringdata_CLASSMenuScreenENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(25, 0),  // ""
        QT_MOC_LITERAL(26, 19),  // "highScoresRequested"
        QT_MOC_LITERAL(46, 13),  // "quitRequested"
        QT_MOC_LITERAL(60, 7)   // "onBlink"
    },
    "MenuScreen",
    "playRequested",
    "",
...
void MenuScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &MenuScreen::playRequested; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MenuScreen::*)();
            if (_t _q_method = &MenuScreen::highScoresRequested; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (MenuScreen::*)();
            if (_t _q_method = &MenuScreen::quitRequested; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void MenuScreen::playRequested()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MenuScreen::highScoresRequested()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void MenuScreen::quitRequested()
{
